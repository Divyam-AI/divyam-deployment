locals {
  ...
  common_vars = {
    environment = "preprod"
    region      = "asia-south1"
    project_id  = "pre-production-project"
    ci_cd_service_account = "244819244005-compute@developer.gserviceaccount.com"
    #########################################################################
  }
  ...
  secrets = {
    ...
    # for openai billing api key export TF_VAR_divyam_openai_billing_api_key=<SECURE_KEY>
  }
