...
inputs = {
  ...
  wif_client_id_map = {
    ...
    "divyam-route-selector" = try(dependency.iam_bindings.outputs.uai_client_ids["route-selector-${local.env}-sa_uai_client_id"], "")
    "divyam-selector-training"     = try(dependency.iam_bindings.outputs.uai_client_ids["selector-training-${local.env}-sa_uai_client_id"], "")
